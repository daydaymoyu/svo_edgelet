...
void Viewer::draw() {
    ...
    static pangolin::Var<bool> menuFollowCamera("menu.Follow Camera", false, true);
    static pangolin::Var<bool> menuShowKeyFrames("menu.Show KeyFrames", true, true);
    static pangolin::Var<bool> menuShowPoints("menu.Show Points", false, true);
    static pangolin::Var<bool> menuShowSeeds("menu.Show Seeds", false, true);
    static pangolin::Var<bool> menuClose("menu.Close", false, false);

    static std::string ss = "SLAM";
    static pangolin::GlText txt = pangolin::GlFont::I().Text(ss.c_str());
